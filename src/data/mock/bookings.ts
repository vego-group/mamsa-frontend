...
export const MOCK_BOOKINGS: Booking[] = [
  ...
  // === منتهية — داخل مهلة الشكوى ===
  // Checked out this morning: the 48-hour complaint window is still open, so
  // the booking page offers «تقديم شكوى» here. BK-005/006 are weeks past it
  // and show the "deadline passed" note instead.
  {
    id: 'BK-009',
    code: 'JUSTLEFT09',
    unitId: 'U-003',
