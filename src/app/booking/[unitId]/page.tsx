    ...
    <div className="container mx-auto grid gap-6 px-4 py-8 md:grid-cols-[1fr_360px]">
      ...
      <div className="space-y-6 md:order-2">
        ...
        <Card className="space-y-3 p-5">
          ...
          <CancellationPolicyDisplay policy={unit.cancellationPolicy} showHeader={false} />
        </Card>
        ...
        <Card className="space-y-2 p-5 text-sm">
          <label className="flex items-start gap-2">
            ...
            <span className="text-brand-muted">
              ...
              كما أوافق على أن يفرض الموقع رسوم على وسيلة الدفع الخاصة بي في حال كنت مسؤولاً عن الأضرار.
            </span>
          </label>
        </Card>
