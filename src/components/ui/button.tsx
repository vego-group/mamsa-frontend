  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline: 'border border-brand-border bg-white text-brand-ink hover:bg-brand-cream/60',
        ghost: 'text-brand-ink hover:bg-brand-cream/60',
        sage: 'bg-brand-sage text-brand-ink hover:bg-brand-sageDark',
        danger: 'bg-status-danger text-white hover:bg-red-700',
        soft: 'bg-brand-cream text-brand-ink hover:bg-brand-cream/70',
